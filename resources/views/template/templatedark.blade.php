...
<head>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" type="image/x-icon" href="assets/images/logo_BLKMjabar.png">
          ...
          <ul class="navbar-nav ml-auto text-center">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown02">
                ...
                <li><a class="dropdown-item" href="{{ url('/daftarKejuruan') }}">Daftar Kejuruan</a></li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown02">
                <li><a class="dropdown-item" href="{{ url('/sk') }}">Syarat dan Ketentuan</a></li>
                <li><a class="dropdown-item" href="{{ url('/kebijakanPrivasi') }}">Kebijakan Privasi</a></li>
              </ul>
            </li>
            <li class="nav-item ">
      ...
      <div class="container">
        <div class="row justify-content-around">
          <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
            <h3>About</h3>
            <p>Integer posuere erat a ante venenati dapibus posuere velit aliquet. Fusce dapibus, tellus cursus commodo,
