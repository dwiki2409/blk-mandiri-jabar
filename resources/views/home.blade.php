		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<h1 data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".1">Balai Latihan Kerja Mandiri <br>
						Provinsi Jawa Barat</h1>
					<p data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".5">Asah keterampilanmu bersama BLK Mandiri Jawa Barat! <br> siap menghadapi tantangan dunia kerja, serta menciptakan peluang usaha secara mandiri. </p>
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-6">
        ...
        <div class="title text-center">
          ...
          Balai Latihan Kerja Mandiri Disnakertrans Jawa Barat menawarkan berbagai program pelatihan dan pengembangan yang dirancang untuk meningkatkan keterampilan dan daya saing peserta. Program kami mencakup berbagai bidang, termasuk pelatihan vokasional, kewirausahaan, dan pengembangan diri.</p>
        ...
        <div class="row text-center">
          <div class="col-md-6 col-sm-6">
            <div class="service-item">
              ...
              <p>Pelatihan kami mencakup strategi manajemen waktu yang efektif untuk membantu peserta memaksimalkan produktivitas dan mencapai tujuan pribadi serta profesional mereka. Peserta akan belajar teknik untuk memprioritaskan tugas, menetapkan tujuan yang dapat dicapai, dan mengelola jadwal mereka dengan efisien.</p>
            </div>
          </div><!-- END COL -->
          <div class="col-md-6 col-sm-6">
            <div class="service-item">
              ...
              <h4>Ide Pemasaran</h4>
              <p>Kami menyediakan strategi pemasaran inovatif yang disesuaikan untuk usaha kecil dan menengah. Sesi pelatihan kami berfokus pada pemasaran digital, branding, dan keterlibatan pelanggan, memungkinkan para pengusaha untuk mempromosikan bisnis mereka secara efektif.</p>
            </div>
          </div><!-- END COL -->
          <div class="col-md-6 col-sm-6">
            <div class="service-item">
              ...
              <p>Peserta menerima dukungan melalui alat-alat pendukung yang dirancang untuk membantu mereka merintis karir setelah menyelesaikan pelatihan. Kami menyediakan akses ke sumber daya, jaringan, dan panduan praktis untuk memfasilitasi transisi peserta ke dunia kerja.</p>
            </div>
          </div><!-- END COL -->
          <div class="col-md-6 col-sm-6">
            <div class="service-item">
              ...
              <p>Di Balai Latihan Kerja Mandiri, kami berkomitmen untuk memberikan pengapingan bagi alumni kami. Kami menjaga hubungan dengan lulusan kami melalui program mentorship, pelatihan lanjutan, dan akses ke peluang kerja, memastikan mereka terus berkembang dalam karir mereka.</p>
            </div>
          </div><!-- END COL -->
        </div>
      </div>
		...
		<div class="row justify-content-center">
			...
			<div class="col-lg-6">
				<div class="title text-center">
					...
					<p>Balai Latihan Kerja Mandiri berkomitmen untuk mengubah kehidupan melalui pendidikan dan pelatihan. Kami mengundang Anda untuk menjelajahi program-program kami yang beragam dan mengambil langkah pertama menuju karier yang sukses. Mari kita bekerja sama untuk mencapai tujuan Anda!</p>
					<div class="border"></div>
				</div>
			</div>
			<!-- /section title -->
		...
		<div class="row">
			...
			<article class="col-lg-4 col-md-6">
				<div class="post-item">
					...
					<div class="content">
						<h3><a href="single-post.html">Pengembangan Keterampilan</a></h3>
						<p>Tetap diperbarui dengan program pelatihan terbaru kami dan kisah sukses dari lulusan kami. Temukan bagaimana inisiatif kami memberikan dampak positif di masyarakat.</p>
			...
			<article class="col-lg-4 col-md-6">
				<div class="post-item">
					...
					<div class="content">
						<h3><a href="single-post.html">Pendekatan Pelatihan Inovatif</a></h3>
						<p>Kami terus menjelajahi metode pelatihan baru untuk meningkatkan pengalaman belajar. Bergabunglah dengan kami saat kami mengadopsi solusi inovatif untuk pengembangan keterampilan.</p>
						<a class="btn btn-main" href="single-post.html">Read more</a>
					</div>
				</div>
			</article>
			...
			<article class="col-lg-4 col-md-6">
				<div class="post-item">
					...
					<div class="content">
						<h3><a href="single-post.html">Tips Pengembangan Karier</a></h3>
						<p>Blog kami menyajikan wawasan dan tips berharga untuk kemajuan karier. Belajar dari para ahli industri dan tingkatkan perjalanan karier Anda.</p>
						<a class="btn btn-main" href="single-post.html">Read more</a>
					</div>
				</div>
			</article>
